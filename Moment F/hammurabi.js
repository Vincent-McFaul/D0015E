...
/* Help button, to toggle showing and hiding text */

function toggleText() {
	var rules = document.getElementById("togglerules");
	var strat = document.getElementById("togglestrat");

	if (rules.style.display === "none" && strat.style.display === "none") {
